    ...
    <Layout>
        ...
        >
          {sent ? (
            <div className="py-16 text-center flex flex-col items-center">
              ...
              <div className="eyebrow fade-up">— Reservation Confirmed</div>
              <h2 className="display mt-6 text-4xl md:text-5xl fade-up">We've got your table.</h2>
              <p className="mt-5 text-muted-foreground leading-relaxed max-w-sm fade-up">
                Our team will confirm your booking shortly via call or email. We look forward to hosting you!
              </p>
              <div className="mt-8 flex gap-4 fade-up">
                <a href="tel:+919845967899" className="btn-ghost !py-3 !px-6 text-xs">Call Us</a>
      ...
      <section className="mx-auto max-w-[1100px] px-6 pb-32">
        ...
        <div className="w-full overflow-hidden border border-border" style={{ height: "380px" }}>
          <iframe
            title="Gulp Cocktails & Kitchen on Google Maps"
            src="https://maps.google.com/maps?q=Gulp+Pub+Bar+Banashankari+Bengaluru&output=embed&z=16"
            width="100%"
            height="100%"
        ...
        <a
          href="https://maps.google.com/?q=Gulp+Pub+Bar+Banashankari+Bengaluru"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-gold hover:underline"
        >
          Open in Google Maps →
        </a>
      </section>
